...
```{r}
ytd = c(80.30, 137.04, 22.08, 39.77, 59.58, 132.51, -8.26, 39.77, -4.22, 20.76, 26.34, 26.41, 178.43, 41.50, 87.29, 18.70, 52.58, 0.51, -6.16, 4.10)
set.seed(456)
...
pred_2021 %>% 
  kbl() %>% 
  kable_styling(bootstrap_options = c("striped", "bordered", "hover", "condensed")) %>% 
  column_spec(c(1,3), color = ifelse(pred_2021$actual_ytd < 0, "red", "black")) %>% 
  scroll_box(width = "100%", height = "500px") 
